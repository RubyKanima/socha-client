from socha import Field, Coordinate, HexCoordinate, CartesianCoordinate, Board
from typing import List, Union, Optional
from socha_extentions import Blob, CustomBoard
...
class CustomBoard(Board):
    ...
    def _get_all_blobs(_board: CustomBoard) -> List[Blob]:
        new_list = []
